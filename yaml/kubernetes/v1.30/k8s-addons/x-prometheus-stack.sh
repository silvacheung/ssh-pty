...
helm upgrade --install kube-prometheus-stack prometheus-community/kube-prometheus-stack \
  ...
  --set prometheusOperator.admissionWebhooks.deployment.replicas={{ get "config.prometheus-stack.replicas" }} \
  ...
  --set prometheus.prometheusSpec.replicas={{ get "config.prometheus-stack.replicas" }} \
  ...
  --set alertmanager.alertmanagerSpec.replicas={{ get "config.prometheus-stack.replicas" }} \
