...
helm upgrade --install harbor-registry harbor/harbor \
  ...
  --set persistence.persistentVolumeClaim.registry.size={{ get "config.harbor.storage_size.registry" }} \
  ...
  --set persistence.persistentVolumeClaim.jobservice.jobLog.size={{ get "config.harbor.storage_size.job_service" }} \
  ...
  --set persistence.persistentVolumeClaim.database.size={{ get "config.harbor.storage_size.database" }} \
  ...
  --set persistence.persistentVolumeClaim.redis.size={{ get "config.harbor.storage_size.redis" }} \
  ...
  --set persistence.persistentVolumeClaim.trivy.size={{ get "config.harbor.storage_size.trivy" }} \
  --set metrics.enabled=true \
  --set metrics.serviceMonitor.enabled=false \
  --set cache.enabled=true \
  --set cache.expireHours=24 \
  --set nginx.image.repository=harbor.silvacheung.com/docker.io/goharbor/nginx-photon \
  --set nginx.image.tag=v2.11.0 \
  ...
  --set portal.image.repository=harbor.silvacheung.com/docker.io/goharbor/harbor-portal \
  --set portal.image.tag=v2.11.0 \
  ...
  --set core.image.repository=harbor.silvacheung.com/docker.io/goharbor/harbor-core \
  --set core.image.tag=v2.11.0 \
  --set core.replicas=3 \
  ...
  --set jobservice.image.repository=harbor.silvacheung.com/docker.io/goharbor/harbor-jobservice \
  --set jobservice.image.tag=v2.11.0 \
  ...
  --set registry.registry.image.repository=harbor.silvacheung.com/docker.io/goharbor/registry-photon \
  --set registry.registry.image.tag=v2.11.0 \
  ...
  --set registry.controller.image.repository=harbor.silvacheung.com/docker.io/goharbor/harbor-registryctl \
  --set registry.controller.image.tag=v2.11.0 \
  ...
  --set trivy.image.repository=harbor.silvacheung.com/docker.io/goharbor/trivy-adapter-photon \
  --set trivy.image.tag=v2.11.0 \
  ...
  --set exporter.image.repository=harbor.silvacheung.com/docker.io/goharbor/harbor-exporter \
  --set exporter.image.tag=v2.11.0 \
  ...
  --set database.internal.image.repository=harbor.silvacheung.com/docker.io/goharbor/harbor-db \
  --set database.internal.image.tag=v2.11.0 \
  ...
  --set redis.internal.image.repository=harbor.silvacheung.com/docker.io/goharbor/redis-photon \
  --set redis.internal.image.tag=v2.11.0 \
